...
def getCellLabels(
    cellmask, rawdata, kernelgblur=21, min_distance=5
):  # cellmask is a np array np.uint8 0=>background 255=>cell
    ...
    local_maxi = feature.peak_local_max(
        image=gblur, min_distance=min_distance, indices=False, labels=cellmask
    )  # find peak
