...
def Identify_DEG(
    ...
    >>> sc.tl.Identify_DEG(adata, min_fold_change=3)
    >>> # visualize results
...
_Method = Optional[Literal['t-test', 'wilcoxon',]]
...
def rank_genes_groups(
    ...
    **kwds,
    ...
    method
        The default method is `'t-test'`, overestimates variance of each group, `'wilcoxon'` uses Wilcoxon rank-sum,
    ...
    corr_method
        ...
        Used only for `'t-test'`, and `'wilcoxon'`.
    tie_correct
