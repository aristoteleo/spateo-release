...
def mask_fill(x,y,fill_mode):
    ...
    if fill_mode=="manual":
        ...
        if num=="2":
            cv.floodFill(img_copy_2, mask_flood_1,seed,color[color_index],(50,50, 50), (50, 50, 50), cv.FLOODFILL_FIXED_RANGE)
        ...
        for i in range(centroids.shape[0]):
            ...
            if x<mask.shape[0] and y<mask.shape[1]:
                ...
                if num=="2":
                    cv.floodFill(img_copy_2, mask_flood_1,(x,y),color[color_index],(150, 150, 150), (150, 150, 150), cv.FLOODFILL_FIXED_RANGE)
            if color_index == (len(color)-1):
                color_index = 0
            else:
                color_index = color_index+1
...
def readData():
    ...
    filepath = "/home/liaoxiaoyan/opencv_test/img_segement/"
    if num=="1":    
        filename = sys.argv[2]
...
#global variable
color = [(192,182,255),(203,192,255),(60,20,220),(245,240,255),(147,112,219),    #b,g,r
        (180,105,255),(147,20,255),(133,21,199),(214,112,218),(216,191,216),
        (221,160,221),(238,130,238),(255,0,255),(255,0,255),(139,0,139),(128,0,128),
        (211,85,186),(211,0,148),(204,50,153),(130,0,75),(226,43,138),(219,112,147),
        (238,104,123),(205,90,106),(139,61,72),(250,230,230),(255,248,248),(255,0,0),
        (205,0,0),(112,25,25),(139,0,0),(128,0,0),(225,105,65),(237,149,100),
        (222,196,176),(153,136,119),(144,128,112),(255,144,30),(255,248,240),
        (180,130,70),(250,206,135),(235,206,135),(255,191,0),(230,216,173),
        (230,224,176),(160,158,95),(255,255,240),(255,255,225),(238,238,175),(255,255,0),
        (209,200,0),(79,79,47),(139,139,0),(128,128,0),(204,209,72),(170,178,32),
        (208,224,64),(170,255,127),(154,250,0),(127,255,0),(250,255,245),(113,179,60),
        (87,139,46),(240,255,240),(144,238,144),(152,251,152),(143,188,143),(50,205,50),
        (0,255,0),(34,139,34),(80,12,0),(0,100,0),(0,255,127),(0,252,124),(47,255,173),
        (47,107,85),(220,245,245),(210,250,250),(240,255,255),(224,255,255),(0,255,255),
        (0,128,128),(107,183,189),(205,250,255),(170,232,238),(140,230,240),(0,215,255),
        (220,248,255),(32,165,218),(240,250,255),(230,245,253),(179,222,245),
        (181,228,255),(0,165,255),(213,239,255),(205,235,255),(173,222,255),
        (215,235,250),(140,180,210),(135,184,222),(196,228,255),(0,140,255),
        (230,240,250),(63,133,205),(185,218,255),(96,164,244),(30,105,210),(19,69,139),
        (238,245,255),(45,82,160),(122,160,255),(80,127,255),(0,69,255),(122,150,233),
        (71,99,255),(225,228,255),(114,128,250),(250,250,255),(128,128,240),
        (143,143,188),(92,92,205),(0,0,255),(42,42,165),(34,34,178),(0,0,139),(0,0,128)] 
'''
...
def main():
    ...
    if num=="2":
        ...
        contours_all=draw_init(img,img_2,img_mask)  #init img_copy,img_copy_2,mask,mask_id,mask_extend,mask_flood,mask_flood_1
    elif num=="1":
