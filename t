...
OOPPTTIIOONNSS
       ...
       --[no-]force-with-lease, --force-with-lease=<refname>, --force-with-lease=<refname>:<expect>
           ...
           saying what exact commit the ref on the remote side must be pointing at, or which refs on the remote side are being
       ...
       --[no-]force-if-includes
           ...
           This option enables a check that verifies if the tip of the remote-tracking ref is reachable from one of the "reflog" entries
           of the local branch based in it for a rewrite. The check ensures that any updates from the remote have been incorporated
           locally by rejecting the forced update if that is not the case.

           If the option is passed without specifying ----ffoorrccee--wwiitthh--lleeaassee, or specified along with ----ffoorrccee--wwiitthh--lleeaassee==<<rreeffnnaammee>>::<<eexxppeecctt>>,
           it is a "no-op".
...
EEXXAAMMPPLLEESS
       ...
       ggiitt ppuusshh oorriiggiinn
           Without additional configuration, pushes the current branch to the configured upstream (bbrraanncchh..<<nnaammee>>..mmeerrggee configuration
...
Git 2.35.3                                                     04/13/2022                                                    GIT-PUSH(1)
